...
client.on("ready", async () => {
  ...
  const FRASES_BOM_DIA = [
    "Bom dia! ☀️ Tecnologia boa é aquela que facilita sua vida. Bora evoluir hoje?",
    "“A inovação distingue um líder de um seguidor.” — Steve Jobs 🍎",
    "Comece o dia com propósito… e com um iPhone top na mão 😎📱",
    "Seu dia fica melhor quando a tecnologia acompanha seu ritmo. 🚀",
    "“Seus clientes mais insatisfeitos são sua maior fonte de aprendizado.” — Bill Gates 💡",
    "Bom dia! 🌅 Hoje é dia de upgrade… de vida e de celular 😉",
    "Não é só um aparelho, é produtividade, estilo e praticidade no seu dia. 📲",
    "Quem começa o dia bem, termina com boas escolhas 💰",
    "“A simplicidade é o último grau de sofisticação.” — Leonardo da Vinci ✨",
    "Bom dia! Já pensou em começar hoje com um iPhone novo na mão? 👀",
    "Tecnologia boa economiza seu tempo… e tempo vale dinheiro 💸",
    "“A melhor maneira de prever o futuro é criá-lo.” — Peter Drucker 🚀",
    "Seu próximo upgrade pode começar hoje. 🔥",
    "Bom dia! Qualidade não é luxo… é investimento 😉",
    "Mais desempenho, mais velocidade, mais resultado no seu dia 📈",
    "“O sucesso normalmente vem para quem está ocupado demais para procurar por ele.” — Henry David Thoreau 💼",
    "Hoje é dia de facilitar sua vida com a tecnologia certa 📱",
    "Um bom aparelho muda sua rotina inteira… pra melhor 😎",
    "Bom dia! Bora começar o dia com desempenho máximo? ⚡",
    "Quem escolhe bem, não se arrepende depois 💡",
    "“Se você não pode fazer algo grande, faça algo pequeno de forma grandiosa.” — Napoleon Hill 🏆",
    "Mais bateria, mais desempenho, menos dor de cabeça 🔋",
    "Seu dia merece um aparelho à altura 📲✨",
    "Bom dia! Pequenos upgrades fazem grande diferença 🚀",
    "Tecnologia não é gasto… é investimento inteligente 💰",
    "“A qualidade significa fazer certo quando ninguém está olhando.” — Henry Ford 🔧",
